...
import (
	...
	. "github.com/nightfury1204/test-apiserver/pkg/client/clientset_generated/clientset/typed/tryapi/v1alpha1"
...
var _ = Describe("Eye controller", func() {
	var instance Eye
	var expectedKey string
	var client EyeInterface
	...
	BeforeEach(func() {
		...
		expectedKey = "eye-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.TryapiV1alpha1().Eyes("eye-controller-test-handler")
