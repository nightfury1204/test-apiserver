...
import (
	...
	"github.com/nightfury1204/test-apiserver/pkg/client/clientset/versioned/scheme"
...
// TryapiV1alpha1Client is used to interact with features provided by the tryapi.nahid.com group.
type TryapiV1alpha1Client struct {
	restClient rest.Interface
}

func (c *TryapiV1alpha1Client) Players(namespace string) PlayerInterface {
