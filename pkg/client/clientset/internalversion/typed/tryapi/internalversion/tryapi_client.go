...
import (
	"github.com/nightfury1204/test-apiserver/pkg/client/clientset/internalversion/scheme"
...
// TryapiClient is used to interact with features provided by the tryapi.nahid.com group.
type TryapiClient struct {
	restClient rest.Interface
}

func (c *TryapiClient) Players(namespace string) PlayerInterface {
	return newPlayers(c, namespace)
}
...
func setConfigDefaults(config *rest.Config) error {
	g, err := scheme.Registry.Group("tryapi.nahid.com")
	if err != nil {
		return err
	}
