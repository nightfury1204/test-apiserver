...
import (
	...
	apis_tryapi "github.com/nightfury1204/test-apiserver/pkg/apis/tryapi"
	...
	tryapi "github.com/nightfury1204/test-apiserver/pkg/client/listers/apis/tryapi"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TryapiTryapi().Players(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TryapiTryapi().Players(namespace).Watch(options)
			},
		},
		&apis_tryapi.Player{},
		resyncPeriod,
...
func (f *playerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apis_tryapi.Player{}, f.defaultInformer)
}

func (f *playerInformer) Lister() tryapi.PlayerLister {
	return tryapi.NewPlayerLister(f.Informer().GetIndexer())
}
